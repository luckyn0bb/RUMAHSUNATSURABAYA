<?php 
    ...
    */
    ...
    $place_ID       = 'ChIJFy7EoT7_1y0RMGrdNIe1uMs'; // Get from: https://developers.google.com/places/place-id
    $business_type  = 'Health'; // Example: FinancialService (http://schema.org)
    $business_name  = 'Rumah Sunat Surabaya';
    $street_address = 'Sambi kerep';
    $locality       = 'Surabaya'; // Example: Docklands (http://schema.org/addressLocality)
    $region         = 'Indonesia';
    $post_code      = '60217';
    $logo_path      = 'logo.png';
    $min_star       = '1'; // The minimum star rating (min = 1)
    $max_rows       = '5'; // The maximum number of results (max = 5)
    $api_key        = 'AIzaSyChenNhn7qq7OY9j-yYrjR5Fbil3ZWYCSk';
?>
<script src="https://code.jquery.com/jquery-2.2.4.min.js"></script>
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyChenNhn7qq7OY9j-yYrjR5Fbil3ZWYCSk&libraries=places"></script>
<script>
    (function($) {
